...
public class FhirResourcesMappingUtils {
    ...
    public Map<String, Object> mapping(HashMap<String, String> mappingConfig, HgscReport hgscReport, byte[] pdfBytes, byte[] excidBytes, HashMap<String, HashMap<String, String>> loincCodeMap) throws ParseException {
            ...
            try {
                switch (resource) {
                    ...
                    case "DiagnosticReport":
                        DiagnosticReport diagnosticReport = new DiagnosticReportValueMapper().diagnosticReportValueMapping(mappingConfig, hgscReport, sdf, pdfBytes, excidBytes);
