...
public class ObsOverallValidator {
    ...
    public boolean validateObsOverallById(String resourceId, HgscReport hgscReport, IGenericClient client) {
        ...
        boolean validatePanelSummaryResult = obsOverall.getExtensionByUrl("https://emerge.hgsc.bcm.edu/fhir/StructureDefinition/interpretation-summary-text").getValue().toString().equals(hgscReport.getPanelSummary());

        boolean validateValueCodeableConceptResult = obsOverall.getValueCodeableConcept().getCodingFirstRep().getDisplay().equals(hgscReport.getOverallInterpretation());
